defmodule ExqUi do
  ...
  def launch_app do
    web_port = Application.get_env(:lc_exq_ui, :web_port, 4040)
    web_namespace = Application.get_env(:lc_exq_ui, :web_namespace, "")
    run_server? = Application.get_env(:lc_exq_ui, :server, true)
